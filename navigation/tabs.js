...
import {Image, Platform, TouchableOpacity, TouchableWithoutFeedback, View,} from "react-native";
...
function CustomTabBarButton({containerStyle, isFloat, children, onPress}) {
    if (isFloat) {
        return (
            <View
                style={{
...
CustomTabBar.propTypes = {props: PropTypes.any};
const Tabs = () => {
